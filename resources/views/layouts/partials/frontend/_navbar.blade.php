        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                <div class="left-top-bar">
                    Livraison gratuite à partie de 10.000 FCFA d'achat
                </div>

                <div class="right-top-bar flex-w h-full">


                    <a href="{{route('connexion')}}" class="flex-c-m trans-04 p-lr-25">
                        Mon compte
                    </a>
            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti " data-notify="{{Cart::count()}}">
                        <a  href="{{route('panier.index')}}" class="icon-header-item cl2 hov-cl1 trans-04 ">
        ...
        <ul class="topbar-mobile">
            ...
            <li>
                <div class="right-top-bar flex-w h-full">
                    ...
                    <a href="{{route('connexion')}}" class="flex-c-m p-lr-10 trans-04">
                        Mon compte
                    </a>
